...
var q3_results = ["<img src= '../img/groomer.jpeg'/>", " If you want to cruise the groomers move up in your board size range. Longer boards provide more stability when going fast. The best part of the groomers is carving, a stiffer board will provide better edge hold for deeper turns, we recomend the Lib Tech Orca snowboard here, hook it up with with a pair of thirty two double BOA boots, and the union flight pro bindings. If you're on a budget swap the board for the Arbor formula.", "<img src= '../img/park.jpeg'/>", " For park, go with a short flexible board, flexy bindings and a softer boot. If you want to do rails avoid rocker shapes. The Capita DOA is king of the park boards, deck it out with a pair of Union Contact Pro bindings, and the Burton Swath Boa boots. If you're on a budget swap the board for the Capita Indoor Survival",
    , "<img src= '../img/powder.jpeg'/>", " If you're riding powder, you will want the longest board in your size range, and you want it to have a wide nose. Grab a pair of stiffer boots and bindings so you have more control in avoiding obstacles. A good powder setup would be the Bataleon Surfer Snowboard, The Union Force bindings, and the Thirtytwo Stevens Snowboard Boots. If your on a budget, swap the board for a Chamonix Chemin Snowboard. it's cheap, it only comes in one size, and it floats in the powder and it's a blast"];
var q4_results = [" Since you live in a sunny area, grab a pair of goggles with darker lenses, you can get lighter lenses later. We recomend the Electric EG 3.5, but if thats too steep, go with the EG2 which is just the best model from last year.", " Since you live in an ovecast area, start with lighter lenses that have a pink tint. The pink tint provides better contrast in flat lighting. We recomend the Oakly Prizm Snow Hi Pink Iridium, these googles are socond to none in flat lighting, we aren't going to recomend a cheaper pair of goggles here because these goggles are really essential"];
var q5_results = [" Since your mountain is warmer you should get a shell jacket and pants, your movement will keep you warm, all you need to do it keep the warmth in and the water out. The TM jacket from Thirtytwo, and the Basement Bib pants is a good place to start, but if money isn't an issue you could splurge for burton AK shell and pants combo and stay dry in any weather conditions", " Since you're on a colder mountain you'll want insulated pants and jacket as well as warm gloves. The colder it is the thicker the jacket should be. the burton AK Gore-Tex 2L LZ down jacket and matching AK Cyclic pant would be our choice for cold weather. If you live somewhere really cold, we don't reccommend trying to save money on things can can actually save your life."];
