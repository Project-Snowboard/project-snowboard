...
var q2_results = [" Since you're new, move down in your size range. Get a rocker shaped board as this board will be more forgiving and easier to turn on--your face will thank you. For new riders we recommend the Lib Tech Skate Banana or if you're on a budget, the Arbor Relapse is a great choice too",
...
var q4_results = [" Since you live in a sunny area grab a pair of goggles with darker lenses (you can get lighter lenses later). We recommend the Electric EG 3.5, but if thats too steep go with the EG2--which is the best model from last year.", " Since you live in an overcast area start with lighter lenses with a pink tint. The pink tint provides better contrast in flat lighting. We recommend the Oakly Prizm Snow Hi Pink Iridium. These googles are second to none in flat lighting. We aren't going to recommend a cheaper pair of goggles here because these goggles really are essential"];
